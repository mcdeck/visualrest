...
/**
 * This is the item provider adapter for a {@link de.van_porten.vrest.core.model.reststructure.PrimitiveDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveDataTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimitiveDataType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveDataType_name_feature", "_UI_PrimitiveDataType_type"),
				 RestStructurePackage.Literals.PRIMITIVE_DATA_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveDataType.class)) {
			case RestStructurePackage.PRIMITIVE_DATA_TYPE__NAME:
