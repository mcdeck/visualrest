...
/**
 * This is the item provider adapter for a {@link de.van_porten.vrest.core.model.restbehavior.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RestBehaviorPackage.Literals.TRANSITION__TARGET_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RestBehaviorPackage.Literals.TRANSITION__TRIGGER);
			childrenFeatures.add(RestBehaviorPackage.Literals.TRANSITION__CONDITION);
			childrenFeatures.add(RestBehaviorPackage.Literals.TRANSITION__EFFECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RestBehaviorPackage.Literals.TRANSITION__TRIGGER,
				 RestBehaviorFactory.eINSTANCE.createInternalMessage()));

		newChildDescriptors.add
			(createChildParameter
				(RestBehaviorPackage.Literals.TRANSITION__CONDITION,
				 RestBehaviorFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add
			(createChildParameter
				(RestBehaviorPackage.Literals.TRANSITION__EFFECT,
