...
/**
 * This is the item provider adapter for a {@link de.van_porten.vrest.core.model.reststructure.InternalLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InternalLinkItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InternalLink_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InternalLink_target_feature", "_UI_InternalLink_type"),
				 RestStructurePackage.Literals.INTERNAL_LINK__TARGET,
				 true,
				 false,
				 true,
				 null,
