...
/**
 * This is the item provider adapter for a {@link de.van_porten.vrest.core.model.reststructure.MethodType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MethodType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MethodType_name_feature", "_UI_MethodType_type"),
				 RestStructurePackage.Literals.METHOD_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((MethodType)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MethodType.class)) {
			case RestStructurePackage.METHOD_TYPE__NAME:
