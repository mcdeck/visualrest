...
/**
 * This is the item provider adapter for a {@link de.van_porten.vrest.core.model.restbehavior.Constant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstantItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RestBehaviorPackage.Literals.CONSTANT__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStringRepresentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constant_stringRepresentation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constant_stringRepresentation_feature", "_UI_Constant_type"),
				 RestBehaviorPackage.Literals.CONSTANT__STRING_REPRESENTATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Constant)object).getStringRepresentation();
