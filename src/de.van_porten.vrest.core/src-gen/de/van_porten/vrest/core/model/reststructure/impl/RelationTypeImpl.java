 ...
 * <ul>
 *   <li>{@link de.van_porten.vrest.core.model.reststructure.impl.RelationTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationTypeImpl extends EObjectImpl implements RelationType {
	...
	protected EClass eStaticClass() {
		return RestStructurePackage.Literals.RELATION_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestStructurePackage.RELATION_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestStructurePackage.RELATION_TYPE__NAME:
				return getName();
		}
