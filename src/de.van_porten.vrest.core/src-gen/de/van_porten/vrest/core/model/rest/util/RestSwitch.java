...
public class RestSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RestPackage.REST_APPLICATION_MODEL: {
				RestApplicationModel restApplicationModel = (RestApplicationModel)theEObject;
				T result = caseRestApplicationModel(restApplicationModel);
	 ...
	 * @generated
	 */
	public T caseRestApplicationModel(RestApplicationModel object) {
		return null;
	}
