 ...
 * $Id$
 */
package de.van_porten.vrest.core.model.rest.util;
...
public class RestAdapterFactory extends AdapterFactoryImpl {
	...
	protected RestSwitch<Adapter> modelSwitch =
		new RestSwitch<Adapter>() {
			@Override
			public Adapter caseRestApplicationModel(RestApplicationModel object) {
				return createRestApplicationModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.van_porten.vrest.core.model.rest.RestApplicationModel <em>Application Model</em>}'.
	 * <!-- begin-user-doc -->
