 ...
 * <ul>
 *   <li>{@link de.van_porten.vrest.core.model.reststructure.impl.InternalLinkImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InternalLinkImpl extends LinkImpl implements InternalLink {
	...
	protected EClass eStaticClass() {
		return RestStructurePackage.Literals.INTERNAL_LINK;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RestStructurePackage.INTERNAL_LINK__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ResourceType newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestStructurePackage.INTERNAL_LINK__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestStructurePackage.INTERNAL_LINK__TARGET:
