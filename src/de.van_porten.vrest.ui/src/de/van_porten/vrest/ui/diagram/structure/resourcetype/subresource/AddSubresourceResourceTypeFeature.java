...
public final class AddSubresourceResourceTypeFeature extends
		AbstractAddResourceTypeFeature {

	public AddSubresourceResourceTypeFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	protected void createIconShape(IPeCreateService peCreateService,
		...
		int polyWidth = width;
		Image image = gaService
				.createImage(
						shape,
						RestImageProvider.IMG_STRUCTURE_SUBRESOURCE_RESOURCE_TYPE_SYMBOL);
		image.setBackground(manageColor(IColorConstant.BLACK));
		gaService.setLocationAndSize(image, 2, 5, polyWidth, polyHeight);
