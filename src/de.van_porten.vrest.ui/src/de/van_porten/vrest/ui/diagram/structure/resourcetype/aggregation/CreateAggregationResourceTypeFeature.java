...
public class CreateAggregationResourceTypeFeature extends AbstractCreateResourceTypeFeature {

	public CreateAggregationResourceTypeFeature(IFeatureProvider fp) {
		super(fp, "Aggregation Resource", "Create Aggregation Resource");
	}

	@Override
	protected ResourceType createResourceTypeInstance() {
		return RestStructureFactory.eINSTANCE.createAggregationResourceType();
	}

	@Override
	public String getCreateImageId() {
		return RestImageProvider.IMG_STRUCTURE_AGGREGATION_RESOURCE_TYPE;
	}
