...
public class CreatorPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, CreatorPropertiesEditionPart {
		...
		composer = new PartComposer(creatorStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RestbehaviorViewsRepository.Creator.Properties.consumedMT) {
					return createConsumedMTReferencesTable(widgetFactory, parent);
				}
				if (key == RestbehaviorViewsRepository.Creator.Properties.creatorParams) {
					return createCreatorParamsTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RestbehaviorMessages.CreatorPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createConsumedMTReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.consumedMT.setHelpText(propertiesEditionComponent.getHelpContent(RestbehaviorViewsRepository.Creator.Properties.consumedMT, RestbehaviorViewsRepository.FORM_KIND));
		this.consumedMT.createControls(parent, widgetFactory);
		this.consumedMT.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.consumedMT, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"consumedMT", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.consumedMT,
	...
	protected void moveConsumedMT(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.consumedMT, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		consumedMT.refresh();
	}
	...
	protected void removeFromConsumedMT(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.consumedMT, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		consumedMT.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createCreatorParamsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.creatorParams = new ReferencesTable(RestbehaviorMessages.CreatorPropertiesEditionPart_CreatorParamsLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.creatorParams, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				creatorParams.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.creatorParams, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				creatorParams.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.creatorParams, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				creatorParams.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.creatorParams, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				creatorParams.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.creatorParams.setHelpText(propertiesEditionComponent.getHelpContent(RestbehaviorViewsRepository.Creator.Properties.creatorParams, RestbehaviorViewsRepository.FORM_KIND));
		this.creatorParams.createControls(parent, widgetFactory);
		this.creatorParams.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreatorPropertiesEditionPartForm.this, RestbehaviorViewsRepository.Creator.Properties.creatorParams, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
