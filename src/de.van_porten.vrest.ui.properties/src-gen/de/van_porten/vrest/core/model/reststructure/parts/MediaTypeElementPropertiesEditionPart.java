 ...
 * 
 */
public interface MediaTypeElementPropertiesEditionPart {

	/**
	 * @return the mtelemType
	 * 
	 */
	...
	/**
	 * Defines a new mtelemType
	 * @param newValue the new mtelemType to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the mtelemType edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
