 ...
 * 
 */
public interface ProjectionResourceTypePropertiesEditionPart {
	...
	/**
	 * @return the projectedType
	 * 
	 */
	public EObject getProjectedType();

	/**
	 * Init the projectedType
	 * @param settings the combo setting
	 */
	public void initProjectedType(EObjectFlatComboSettings settings);

	/**
	 * Defines a new projectedType
	 * @param newValue the new projectedType to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the projectedType edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
