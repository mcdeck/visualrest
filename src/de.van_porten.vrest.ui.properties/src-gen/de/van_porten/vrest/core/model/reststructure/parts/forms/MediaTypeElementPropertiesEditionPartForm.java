 ...
 * 
 */
public class MediaTypeElementPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, MediaTypeElementPropertiesEditionPart {
	 ...
	 * 
	 */
	public MediaTypeElementPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(mediaTypeElementStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ReststructureViewsRepository.MediaTypeElement.Properties.mtelemType) {
					return createMtelemTypeFlatComboViewer(parent, widgetFactory);
				}
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ReststructureMessages.MediaTypeElementPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createMtelemTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ReststructureMessages.MediaTypeElementPropertiesEditionPart_MtelemTypeLabel, propertiesEditionComponent.isRequired(ReststructureViewsRepository.MediaTypeElement.Properties.mtelemType, ReststructureViewsRepository.FORM_KIND));
		mtelemType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ReststructureViewsRepository.MediaTypeElement.Properties.mtelemType, ReststructureViewsRepository.FORM_KIND));
		widgetFactory.adapt(mtelemType);
		...
		mtelemType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MediaTypeElementPropertiesEditionPartForm.this, ReststructureViewsRepository.MediaTypeElement.Properties.mtelemType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getMtelemType()));
			}

		});
		mtelemType.setID(ReststructureViewsRepository.MediaTypeElement.Properties.mtelemType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ReststructureViewsRepository.MediaTypeElement.Properties.mtelemType, ReststructureViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ReststructureMessages.MediaTypeElementPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ReststructureViewsRepository.MediaTypeElement.Properties.name, ReststructureViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MediaTypeElementPropertiesEditionPartForm.this, ReststructureViewsRepository.MediaTypeElement.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ReststructureViewsRepository.MediaTypeElement.Properties.name, ReststructureViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
