 ...
 * 
 */
public interface FilterResourceTypePropertiesEditionPart {
	...
	/**
	 * Init the listElementType
	 * @param settings the combo setting
	 */
	public void initListElementType(EObjectFlatComboSettings settings);

	/**
	 * Defines a new listElementType
	 * @param newValue the new listElementType to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the listElementType edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
