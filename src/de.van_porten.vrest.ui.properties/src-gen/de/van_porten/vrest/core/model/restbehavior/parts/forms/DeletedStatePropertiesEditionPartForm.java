 ...
 * 
 */
public class DeletedStatePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DeletedStatePropertiesEditionPart {
	 ...
	 * 
	 */
	public DeletedStatePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RestbehaviorMessages.DeletedStatePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createTransitionsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.transitions = new ReferencesTable(RestbehaviorMessages.DeletedStatePropertiesEditionPart_TransitionsLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.transitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				transitions.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.transitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				transitions.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.transitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				transitions.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.transitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				transitions.refresh();
			}
		...
		this.transitions.setHelpText(propertiesEditionComponent.getHelpContent(RestbehaviorViewsRepository.DeletedState.Properties.transitions, RestbehaviorViewsRepository.FORM_KIND));
		...
		this.transitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.transitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, RestbehaviorMessages.DeletedStatePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(RestbehaviorViewsRepository.DeletedState.Properties.name, RestbehaviorViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RestbehaviorViewsRepository.DeletedState.Properties.name, RestbehaviorViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSupportedMethodsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.supportedMethods.setHelpText(propertiesEditionComponent.getHelpContent(RestbehaviorViewsRepository.DeletedState.Properties.supportedMethods, RestbehaviorViewsRepository.FORM_KIND));
		this.supportedMethods.createControls(parent, widgetFactory);
		this.supportedMethods.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.supportedMethods, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"supportedMethods", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.supportedMethods,
	...
	protected void moveSupportedMethods(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.supportedMethods, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		supportedMethods.refresh();
	}
	...
	protected void removeFromSupportedMethods(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeletedStatePropertiesEditionPartForm.this, RestbehaviorViewsRepository.DeletedState.Properties.supportedMethods, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		supportedMethods.refresh();
	}
