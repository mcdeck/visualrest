 ...
 * 
 */
public class ExternalLinkPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ExternalLinkPropertiesEditionPart {
	 ...
	 * 
	 */
	public ExternalLinkPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ReststructureMessages.ExternalLinkPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ReststructureMessages.ExternalLinkPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ReststructureViewsRepository.ExternalLink.Properties.name, ReststructureViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalLinkPropertiesEditionPartForm.this, ReststructureViewsRepository.ExternalLink.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ReststructureViewsRepository.ExternalLink.Properties.name, ReststructureViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRelTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ReststructureMessages.ExternalLinkPropertiesEditionPart_RelTypeLabel, propertiesEditionComponent.isRequired(ReststructureViewsRepository.ExternalLink.Properties.relType, ReststructureViewsRepository.FORM_KIND));
		relType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ReststructureViewsRepository.ExternalLink.Properties.relType, ReststructureViewsRepository.FORM_KIND));
		...
		relType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalLinkPropertiesEditionPartForm.this, ReststructureViewsRepository.ExternalLink.Properties.relType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRelType()));
			}

		});
		relType.setID(ReststructureViewsRepository.ExternalLink.Properties.relType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ReststructureViewsRepository.ExternalLink.Properties.relType, ReststructureViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
