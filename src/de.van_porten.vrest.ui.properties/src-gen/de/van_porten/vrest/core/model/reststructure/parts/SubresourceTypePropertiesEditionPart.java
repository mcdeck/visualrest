 ...
 * 
 */
public interface SubresourceTypePropertiesEditionPart {
	...
	/**
	 * Init the containingType
	 * @param settings the combo setting
	 */
	public void initContainingType(EObjectFlatComboSettings settings);

	/**
	 * Defines a new containingType
	 * @param newValue the new containingType to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the containingType edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
