 ...
 * 
 */
public class ReturnActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ReturnActionPropertiesEditionPart {
...
protected List<ViewerFilter> metadataFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public ReturnActionPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(returnActionStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				if (key == RestbehaviorViewsRepository.ReturnAction.metadata) {
					return createMetadataAdvancedTableComposition(parent);
				}
				return parent;
			}
		};
	 ...
	 * 
	 */
	protected Composite createMetadataAdvancedTableComposition(Composite parent) {
		this.metadata = new ReferencesTable(RestbehaviorMessages.ReturnActionPropertiesEditionPart_MetadataLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReturnActionPropertiesEditionPartImpl.this, RestbehaviorViewsRepository.ReturnAction.metadata, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				metadata.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReturnActionPropertiesEditionPartImpl.this, RestbehaviorViewsRepository.ReturnAction.metadata, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				metadata.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReturnActionPropertiesEditionPartImpl.this, RestbehaviorViewsRepository.ReturnAction.metadata, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				metadata.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReturnActionPropertiesEditionPartImpl.this, RestbehaviorViewsRepository.ReturnAction.metadata, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				metadata.refresh();
			}
		...
		this.metadata.setHelpText(propertiesEditionComponent.getHelpContent(RestbehaviorViewsRepository.ReturnAction.metadata, RestbehaviorViewsRepository.SWT_KIND));
		this.metadata.createControls(parent);
		this.metadata.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReturnActionPropertiesEditionPartImpl.this, RestbehaviorViewsRepository.ReturnAction.metadata, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
