 ...
 * 
 */
public class ComplexIdentifierPatternPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ComplexIdentifierPatternPropertiesEditionPart {
	 ...
	 * 
	 */
	public ComplexIdentifierPatternPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(complexIdentifierPatternStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idParams) {
					return createIdParamsReferencesTable(widgetFactory, parent);
				}
				if (key == ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idAttrs) {
					return createIdAttrsReferencesTable(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ReststructureMessages.ComplexIdentifierPatternPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createIdParamsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.idParams.setHelpText(propertiesEditionComponent.getHelpContent(ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idParams, ReststructureViewsRepository.FORM_KIND));
		this.idParams.createControls(parent, widgetFactory);
		this.idParams.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComplexIdentifierPatternPropertiesEditionPartForm.this, ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idParams, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"idParams", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComplexIdentifierPatternPropertiesEditionPartForm.this, ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idParams,
	...
	protected void moveIdParams(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComplexIdentifierPatternPropertiesEditionPartForm.this, ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idParams, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		idParams.refresh();
	}
	...
	protected void removeFromIdParams(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComplexIdentifierPatternPropertiesEditionPartForm.this, ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idParams, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		idParams.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createIdAttrsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.idAttrs.setHelpText(propertiesEditionComponent.getHelpContent(ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idAttrs, ReststructureViewsRepository.FORM_KIND));
		this.idAttrs.createControls(parent, widgetFactory);
		this.idAttrs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComplexIdentifierPatternPropertiesEditionPartForm.this, ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idAttrs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIdAttrs() {
		...
		"idAttrs", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComplexIdentifierPatternPropertiesEditionPartForm.this, ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idAttrs,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				idAttrs.refresh();
			}
	...
	protected void moveIdAttrs(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComplexIdentifierPatternPropertiesEditionPartForm.this, ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idAttrs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		idAttrs.refresh();
	}
	...
	protected void removeFromIdAttrs(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComplexIdentifierPatternPropertiesEditionPartForm.this, ReststructureViewsRepository.ComplexIdentifierPattern.Properties.idAttrs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		idAttrs.refresh();
	}
