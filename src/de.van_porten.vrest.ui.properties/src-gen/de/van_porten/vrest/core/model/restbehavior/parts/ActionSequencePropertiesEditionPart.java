 ...
 * 
 */
public interface ActionSequencePropertiesEditionPart {



	/**
	 * Init the actionelements
	...
	/**
	 * Update the actionelements
	 * @param newValue the actionelements to update
	 * 
	 */
	public void updateActionelements();

	/**
	 * Adds the given filter to the actionelements edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the actionelements table
	 * 
	 */
