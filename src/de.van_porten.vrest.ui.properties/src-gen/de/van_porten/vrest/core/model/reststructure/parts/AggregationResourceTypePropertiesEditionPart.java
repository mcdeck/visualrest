 ...
 * 
 */
public interface AggregationResourceTypePropertiesEditionPart {
	...
	/**
	 * Init the elementTypes
	 * @param settings settings for the elementTypes ReferencesTable 
	 */
	public void initElementTypes(ReferencesTableSettings settings);

	/**
	 * Update the elementTypes
	 * @param newValue the elementTypes to update
	 * 
	 */
	public void updateElementTypes();

	/**
	 * Adds the given filter to the elementTypes edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the elementTypes table
	 * 
	 */
